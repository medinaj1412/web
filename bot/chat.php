...
$questions = [
    ...
    "cuales son los metodos de pago?" => "El pago se realiza haciendo una transferencia a cuenta bancaria.",
    "cual es su direccion?" => "Puedes acercarte a la Av. Separadora Industrial 123.",
    "cual es el precio?" => "Cada producto tiene su precio lo podrás encontrar debajo de cada imagen.",
    "cual es su telefono?" => "La información de contacto aparecerá cuando presionas la opción Comprar.",
    "cuales son los protocolos?" => "Debes acercarte con doble mascarilla de manera obligatoria, cuando ingreses te ayudamos con la desinfección.",
    "cual es el horario de atencion?" => "Atendemos de 9am a 6pm.",
    "cuanto hay de descuento?" => "No, no hay descuentos, los productos son de buena calidad, no se arrepentirá.",
    "hacen delivery?" => "Si, descúbre el proceso en la opción Comprar.",
    "que ofrecen?" => "Tenemos los mejores productos orgánicos a buen precio. Los llevamos a tu domicilio, o si deseas puedes recoger tu pedido en tienda.",

    //duracion
    "tienes nombre?"=>"me llamo roxana",
    ...
    //name
    "como te llamas?" =>"Soy roxana y estoy para servirte",
    "cual es tu nombre?" =>"Soy roxana y estoy para servirte",
    "tienes nombre?" =>"Soy roxana y estoy para servirte",
...
if (isset($_GET['msg'])) {
    ...
    $bot->hears($msg, function (Bot $botty) {
        ...
        if ($msg == 'hi' || $msg == "hello") {
            ...
            $botty->reply("Lo siento, no comprendo la pregunta.");
        } else {
